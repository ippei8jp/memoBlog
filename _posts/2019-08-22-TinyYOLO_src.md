---
title: Intel NCStick用TinyYOLOのソース読んでみた(プログラムソース)
date: 2019-08-22
tags: ["DeepLearning", "TinyYOLO"]
excerpt: Intel NCStick用TinyYOLOのソース読んでみた(プログラムソース)
---

Intel NCStick用TinyYOLOの[ソース](https://github.com/movidius/ncappzoo/blob/ncsdk2/caffe/TinyYolo/run.py)のコピー  
